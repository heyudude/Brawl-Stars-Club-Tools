...
from bstools.models import Demerit, MemberVacation, MemberCustomRecord
...
def get_member_data_from_sheets(config):
    ...
    config['members']['vacation'] = get_vacation_data_from_sheet(sheet, sheet_id, config['bstools']['timestamp'], config['members']['vacation'])
